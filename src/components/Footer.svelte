<footer class="py-20 sm:py-32 border-t border-solid border-violet-950 bg-slate-900">
    <div class="container mx-auto px-6">
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
            
            <!-- Información Principal -->
            <div class="md:col-span-2">
                <h3 class="text-2xl font-bold text-violet-400 mb-4">
                    Tomás Álvarez
                </h3>
                ...
                <div class="flex space-x-4">
                    ...
                    <a href="https://linkedin.com" aria-label="LinkedIn" target="_blank" rel="noopener noreferrer"
                       class="w-10 h-10 bg-slate-800 hover:bg-violet-600 rounded-full flex items-center justify-center transition-colors">
                        <span class="text-white text-sm">LI</span>
                    </a>
                    <a href="https://twitter.com" aria-label="Twitter" target="_blank" rel="noopener noreferrer"
                       class="w-10 h-10 bg-slate-800 hover:bg-violet-600 rounded-full flex items-center justify-center transition-colors">
                        <span class="text-white text-sm">TW</span>
                    </a>
                    <a href="mailto:contacto@example.com" aria-label="Email"
                       class="w-10 h-10 bg-slate-800 hover:bg-violet-600 rounded-full flex items-center justify-center transition-colors">
